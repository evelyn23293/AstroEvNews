...
const datosCuriosos = [
  ...
  "El Sol es una estrella de tipo G2V, lo que significa que es una estrella de la secuencia principal.",
  ...
  "En 2009, la nave Lunar CRater Observation and Sensing Satellite (LCROSS) envió datos que confirmaron de forma concluyente la existencia de hielo en el polo sur de la Luna.",
  ...
  "La Luna es la única satélite natural de la Tierra y es visible en la noche desde cualquier lugar del planeta.",
  ...
  "En 2014, investigadores descubrieron por primera vez la presencia de placas tectónicas en un lugar distinto a la Tierra, fue en Europa, una de las lunas de Júpiter.",
  "El registro más antiguo de un eclipse anular de Sol se realizó en Irlanda, el 30 de noviembre del año 3340 a.C.",
  "El 14 de enero de 2005, la sonda Huygens se convirtió en el primer objeto construido por el ser humano en aterrizar en la luna de Saturno, Titán."
];
